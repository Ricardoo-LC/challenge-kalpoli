        ...
        <div className="max-h-full w-full max-w-xl sm:rounded-2xl bg-[#F3F3F3] border border-slate-800 text-black dark:bg-[#262B3C] dark:border dark:border-slate-400 dark:text-white">
            <div className="my-10 mx-20">
                ...
                <div className="flex items-center justify-between rounded-t-3xl p-3 w-full">
                    ...
                    <h1 className="mb-4 text-3xl font-roboto font-bold text-center">{plays}</h1>
                    <span className="mt-2 text-xl font-semibold">Jugadas</span>
                </div>
                <div className="text-center">
                    <h1 className="mb-4 text-3xl font-roboto font-bold text-center">{victories}</h1>
                ...
                <div className="space-y-4 flex items-center justify-center">
                    <button className="px-16 py-1 bg-correct rounded-[5px] text-2xl font-roboto font-semibold text-center text-white" onClick={handleClick}>Aceptar</button>
                </div>
            </div>
        </div>
    </div>
