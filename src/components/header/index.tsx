...
export const Header = ({ showInstructions, showStadistics }: Props) => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center rounded-[15px] w-3/12 mx-auto p-4 bg-neutral-100 bg-clip-border shadow-md shadow-[#F3F3F3] dark:bg-slate-800 dark:text-white dark:shadow-none">
