...
export const Header = ({ showInstructions, showStadistics }: Props) => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center rounded-[15px] w-11/12 md:w-10/12 lg:w-5/12 mx-auto p-4 bg-neutral-100 bg-clip-border shadow-md shadow-[#F3F3F3] dark:bg-slate-800 dark:text-white dark:shadow-none">
        <div className="flex items-center justify-between rounded-t-3xl p-3 w-full">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 fill-neutral-600 dark:fill-neutral-200 cursor-pointer" onClick={handleClickQuestion}>
