export const Keyboard: React.FC = () => {
  return (
    <div className="relative flex flex-col items-center rounded-[15px] w-[576px] mx-auto p-4 bg-neutral-100 bg-clip-border shadow-md shadow-[#F3F3F3] dark:bg-slate-800 dark:text-white dark:shadow-none pt-10">
