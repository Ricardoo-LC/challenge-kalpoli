...
export const Key = ({ value, status, onKeyPressed }: KeyProps) => {
  const widhtBoxes = {
    ENTER: 'sm:w-12 md:w-16 xl:w-20',
    DELETE: 'sm:w-12 md:w-16 xl:w-20',
    default: 'sm:w-8 md:w-10 xl:w-12'
  }
  ...
  return (
    <div
      className={`h-14 sm:h-10 md:h-12 xl:h-14 ${widhtBox} bg-gray-300 dark:bg-[#565F7E] rounded-[5px] flex items-center justify-center text-center cursor-pointer`}
      onClick={e => eventKey(e)}
    >
